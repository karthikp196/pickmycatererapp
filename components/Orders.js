                ...
                return (
                    ...
                    <View style={styles.bodystyle}>
                        ...
                        </View>
                        {
                            ...
                            <ListItem key={i} containerStyle={styles.Containstyle} bottomDivider onPress={() => this.props.navigation.navigate('orders', {
                                Order_token: l.order_token,
                              })}>
                               <Avatar source={{uri:"http://pickmycaterer.com/wp-content/uploads/2021/02/logo5.png"}} />
                                ...
                                <ListItem.Subtitle style={styles.listsub}>{"New"}</ListItem.Subtitle>
                                </ListItem.Content>
                                <ListItem.Chevron />
                            </ListItem>
                            ))
